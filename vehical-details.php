          ...
          <div class="sidebar_widget">
            ...
            <form method="post">
              <div class="form-group">
                ...
                <input type="datetime-local" class="form-control" name="fromdate" placeholder="From Date & Time" required>
              </div>
              <div class="form-group">
                <label>To Date:</label>
                <input type="datetime-local" class="form-control" name="todate" placeholder="To Date & Time" required>
              </div>
              <div class="form-group">
                <textarea rows="4" class="form-control" name="message" placeholder="Message (Optional)" ></textarea>
              </div>
